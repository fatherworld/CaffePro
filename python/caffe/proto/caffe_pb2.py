...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MYNEURON', index=40, number=40,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='my_neuron_param', full_name='caffe.LayerParameter.my_neuron_param', index=13,
...
_MYNEURONPARAMETER = _descriptor.Descriptor(
  name='MyNeuronParameter',
  full_name='caffe.MyNeuronParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='power', full_name='caffe.MyNeuronParameter.power', index=0,
...
_LAYERPARAMETER.fields_by_name['my_neuron_param'].message_type = _MYNEURONPARAMETER
...
DESCRIPTOR.message_types_by_name['MyNeuronParameter'] = _MYNEURONPARAMETER
...
MyNeuronParameter = _reflection.GeneratedProtocolMessageType('MyNeuronParameter', (_message.Message,), dict(
  DESCRIPTOR = _MYNEURONPARAMETER,
  __module__ = 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MyNeuronParameter)
  ))
_sym_db.RegisterMessage(MyNeuronParameter)
